 ...
 * in a {@link MusiquePubliqueListActivity}.
 */
public class MusiquePubliqueDetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, MusiquePubliqueListActivity.class));
            return true;
        }
