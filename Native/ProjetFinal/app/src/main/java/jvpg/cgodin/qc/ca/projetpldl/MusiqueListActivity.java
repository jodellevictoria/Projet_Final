 ...
 */
public class MusiqueListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final MusiqueListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(MusiqueDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    Intent intent = new Intent(context, MusiqueDetailActivity.class);
                    intent.putExtra(MusiqueDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(MusiqueListActivity parent,
                                      List<Musique> items,
                                      boolean twoPane) {
            mValues = items;
    ...
    public void fillList(){
        ...
        try {
            ...
            for(int i = 0; i < musiquesJSON.length(); i++){
                ...
                m.setId(musique.getInt("proprietaire"));
                ...
                Log.i("MusiqueListActivity",m.toString());
            }
